...
# Source0-md5:	5982cc473d7eb6bfe289c95be7e505d3
...
%config(noreplace) %verify(not md5 mtime size) /lib/udev/rules.d/95-upower-battery-recall-*.rules
%config(noreplace) %verify(not md5 mtime size) /lib/udev/rules.d/95-upower-csr.rules
%config(noreplace) %verify(not md5 mtime size) /lib/udev/rules.d/95-upower-hid.rules
%config(noreplace) %verify(not md5 mtime size) /lib/udev/rules.d/95-upower-wup.rules
